...
if "longitude" in validation_examples.columns and "latitude" in validation_examples.columns :
...
california_housing_test_data = pd.read_csv("https://storage.googleapis.com/mledu-datasets/california_housing_test.csv",
                                           sep=",")
